...
export const firstSemSchedule = {
    ...
    courses: [
        ...
        { time: '06:00 PM', endTime: '09:00 PM', day: 'Thursday', name: 'PROFESSIONAL ELECTIVE 1', room: 'VR' },
        { time: '03:00 PM', endTime: '05:00 PM', day: 'Thursday', name: 'PHYSICAL ACTIVITIES TOWARD HEALTH AND FITNESS 1', room: 'OVAL - Track Oval B' },

        // Friday Classes
        { time: '03:00 PM', endTime: '04:30 PM', day: 'Friday', name: 'OPERATION MANAGEMENT AND TQM', room: 'VR' },
        { time: '01:30 PM', endTime: '03:00 PM', day: 'Friday', name: 'ECONOMIC DEVELOPMENT', room: 'HPSB - 1014' },
        { time: '10:30 AM', endTime: '12:00 PM', day: 'Friday', name: 'MAKATI HERITAGE STUDIES 1', room: 'VR' },
